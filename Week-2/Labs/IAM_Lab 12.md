...
The lab also involved verifying the subnet configuration of the **DC-Server** and **Win11-Client** using ipconfig /all and practicing subnetting calculations using /24 and /8 networks.
...
| Client Machine | Win11-Client |
| Domain | mydomain.com |
| DC IPv4 Address | 172.16.0.1 |
| Client IPv4 Address | 172.16.0.50 or an address within the range |
...
| Usable IPs | 172.16.0.1 – 172.16.0.254 |
| Subnet Mask | 255.255.255.0 |
| Total IPs | 256 |
| Usable IPs | 254 |
...
| 192.168.1.0/24 Usable IPs | 192.168.1.1 – 192.168.1.254 |
| 10.0.0.0/8 Network Address | 10.0.0.0 |
| 10.0.0.0/8 Broadcast Address | 10.255.255.255 |
| 10.0.0.0/8 Usable IPs | 10.0.0.1 – 10.255.255.254 |
...
The subnet configuration of both the **DC-Server** and **Win11-Client** was then verified using ipconfig /all. Finally, subnetting calculations were practiced using 192.168.1.0/24 and 10.0.0.0/8.
